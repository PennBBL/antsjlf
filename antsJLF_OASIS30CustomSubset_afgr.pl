...
my @{XCPEDIR}="/xcpEngine";

my @brainDir="/Users/adebimpe/Documents/GitHub/xcpEngine/thirdparty/oasis30/Heads";

if ($brainExtracted > 0) {
    @brainDir="/Users/adebimpe/Documents/GitHub/xcpEngine/thirdparty/oasis30/Brains";
}

my @segDir="/Users/adebimpe/Documents/GitHub/xcpEngine/thirdparty/oasis30/Segmentations";
...
my @{ANTSPATH}="/opt/ANTs_JLF/";

system("/opt/ANTs_JLF/antsJointLabelFusion.sh -d 3 -q 0 -f 0 -j 2 -k $keepWarps -t $target -o $outputRoot -c 1 $atlasString");
