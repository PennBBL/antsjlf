...
Optional arguments:
     ...
     -r:  radius for cross correlation metric used during SyN stage (default = 3)
...
while getopts "d:f:h:j:m:n:o:p:r:s:t:v:" OPT
  do
  case $OPT in
      h) #help
   Help
   ...
   ;;
   v)     # Verbose, where verbose means saying anything at all
   VERBOSE=$OPTARG
   ;;
